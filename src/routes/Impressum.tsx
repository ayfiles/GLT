        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="space-y-6 text-gray-800 leading-relaxed">
            <div>
              ...
              <p className="mt-4"><span className="font-semibold">Umsatzsteuer-ID:</span><br />Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: DE359706013</p>
              <p className="mt-4"><span className="font-semibold">Zuständige Kammer:</span><br />Handwerkskammer Düsseldorf - Georg-Schulhoff-Platz 1, 40221 Düsseldorf</p>
              <p className="mt-4"><span className="font-semibold">Inhaltlicher Verantwortlicher im Sinne des § 18 Abs. 2 MStV</span><br />Sinan Gültekin<br />Ritterstr. 49<br />47228 Duisburg</p>
            </div>
            ...
            <div>
              <h2 className="text-2xl font-semibold mb-2">Google AdSense</h2>
              <p>
